...
func TestMatch(t *testing.T) {
	...
	cases := []struct {
		...
		{Query{IPv4: "10.20.30.40"}, Machine{Network: map[string]MachineNetwork{
			"node0": MachineNetwork{
				IPv4: []string{"10.20.30.40", "10.21.30.40"},
			},
		}}, true},
		{Query{IPv6: "aa::ff"}, Machine{Network: map[string]MachineNetwork{
			"node0": MachineNetwork{
				IPv6: []string{"aa::ff", "bb::ff"},
			},
		}}, true},
		...
		{Query{IPv4: "10.20.30.40"}, Machine{Network: map[string]MachineNetwork{
			"node0": MachineNetwork{
				IPv4: []string{"10.21.30.40", "10.22.30.40"},
			},
		}}, false},
		{Query{IPv6: "aa::ff"}, Machine{Network: map[string]MachineNetwork{
			"node0": MachineNetwork{
				IPv6: []string{"bb::ff", "cc::ff"},
			},
		}}, false},
		{Query{IPv4: "10.20.30.40"}, Machine{Network: map[string]MachineNetwork{
			"node0": MachineNetwork{},
